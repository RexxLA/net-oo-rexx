...
bundle = "net-oo-rexx.windows.x86_64-portable-release-" || date("Standard")
...
call mirrorDirC cache"/oorexx-portable/windows.x86_64", bundle"/oorexx", /*recursive*/ .true, /*ignoreTopLevelDirectory*/ .true
