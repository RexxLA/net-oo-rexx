...
bundle = "net-oo-rexx.ubuntu2404.x86_64-portable-release-" || date("Standard")
...
call mirrorDirC cache"/oorexx-portable/ubuntu2404.x86_64", bundle"/oorexx", /*recursive*/ .true, /*ignoreTopLevelDirectory*/ .true
